    ...
    <div className="w-full text-white p-5 m-5 bg-[#1d2844] max-w-lg mx-auto md:p-12 my-5 rounded-lg shadow-md ">
      <div>
        ...
        <div className="flex justify-end mt-5">
          <div className="hover:bg-black w-8 h-8 flex justify-center items-center rounded me-2">
            <FaRegEdit className="w-5 h-5" />
          </div>
          <div className="hover:bg-black w-8 h-8 flex justify-center items-center rounded">
