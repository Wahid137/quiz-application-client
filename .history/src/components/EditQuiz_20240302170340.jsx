...
const EditQuiz = () => {
  ...
  console.log(quiz);
  console.log(quiz[0]?.category);
  console.log(parseInt(quiz[0]?.category?.split(" ")?.[1]) || "");
  ...
  const [incorrectTwo, setIncorrectTwo] = useState(
    quiz[quiz[0]?.incorrectAnswers[1]]
  );
  const [incorrectThree, setIncorrectThree] = useState(
    quiz[quiz[0]?.incorrectAnswers[2]]
  );
          ...
          <form className="card-body" onSubmit={handleSubmit}>
            <div className="form-control">
              ...
              <input
                ...
                value={parseInt(quiz[0]?.category?.split(" ")?.[1]) || ""}
            ...
            <div className="form-control">
              ...
              <input
                ...
                className="input input-bordered"
                value={quiz[0]?.incorrectAnswers[1]}
            ...
            <div className="form-control">
              ...
              <input
                ...
                className="input input-bordered"
                value={quiz[0]?.incorrectAnswers[2]}
