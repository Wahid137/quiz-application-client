        ...
        <div className="bg-secondary max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
          ...
          <div className="mt-10">
            <form onSubmit={handleLogin} className="flex flex-col">
              ...
              <button
                className="bg-accent hover:bg-slate-500 text-slate-100 dark:bg-primary dark:text-accent px-10 py-2 rounded float-right flex items-center gap-2 justify-center"
                type="submit"
              >
                Sign In
              </button>
