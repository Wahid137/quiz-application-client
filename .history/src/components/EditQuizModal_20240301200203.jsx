const EditQuizModal = ({ quiz }) => {
  ...
  return (
    <>
      {" "}
      // Convert incorrectAnswers to an array if it's not already const
      incorrectAnswersArray = Array.isArray(incorrectAnswers) ? incorrectAnswers
      : [incorrectAnswers]; // Combine correct and incorrect answers into a
      single array const options = [correctAnswer, ...incorrectAnswersArray];
