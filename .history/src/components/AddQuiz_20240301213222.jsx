        ...
        <div className="card shadow-2xl bg-[#1d2844]">
          <form className="card-body ">
            ...
            <div className="form-control mt-6 w-1/2 mx-auto">
              <button className=
  "bg-accent text-slate-100 dark:bg-primary dark:text-accent px-10 py-2 rounded-full float-right flex items-center gap-2 justify-center";">Add Question</button>
            </div>
          </form>
        </div>
      </div>
