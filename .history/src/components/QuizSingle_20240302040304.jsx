        ...
        <div>
          ...
          <div className="flex justify-end mt-5">
            <Link to={`/dashboard/editquiz/${_id}`}>
              <div className="bg-accent hover:bg-slate-600  w-10 h-10 flex justify-center items-center rounded me-2">
                <FaRegEdit className="w-5 h-5" />
              </div>
            </Link>
            <div
              onClick={() => handleDelete(_id)}
              className="bg-accent hover:bg-slate-600 w-10 h-10 flex justify-center items-center rounded"
            >
