  ...
  return (
    ...
    >
      ...
      <div className="lg:w-[80%] md:w-[90%] w-[90%] mx-auto text-left">
        ...
        <div className="flex ms-30">
          <ul className="text-sm my-10">
            <li className="my-4">
              <span className="bg-orange-200 px-2 rounded">Step 1:</span> Click
              on the
            ...
            <li className="my-4">
              <span className="bg-orange-200 px-2 rounded">Step 3:</span> You
              will see the questions with 4 options for each!
            </li>
            <li className="my-4">
              <span className="bg-orange-200 px-2 rounded">Step 4:</span> You
              have to select the correct answer!
            </li>
            <li className="my-4">
              <span className="bg-orange-200 px-2 rounded">Step 5:</span> You
              can not skip question without giving answer!
            </li>
          </ul>
        </div>
      </div>
      <Link to="/quiz">
        <button
          className="bg-green-600 px-20 py-2 text-white rounded"
          id="startQuiz"
        >
          Start Quiz
        </button>
