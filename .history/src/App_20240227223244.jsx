  ...
  return (
    ...
    <header class="h-16 flex items-center shadow-sm">
      <nav class="flex justify-between items-center w-9/12 mx-auto">
        ...
        <button
          class="bg-green-600 font-light text-sm px-5 py-1 rounded text-white"
        >
          Blog
        </button>
      </nav>
    ...
    <section
      class="lg:w-9/12 md:w-[90%] w-[95%] mx-auto text-center"
      id="rulesContainer"
    >
    ...
    <section
      class="shadow-sm my-5 py-2 sticky top-0 bg-white z-10 hidden"
      id="alertContainer"
    >
      <div
        class="w-9/12 mx-auto flex md:flex-row flex-col justify-between items-center"
      >
    ...
    <!-- Quiz section start -->
    <section
      class="md:w-9/12 w-[90%] md:flex-row flex-col mx-auto hidden"
      id="submitContainer"
    >
      <!-- Question section start -->
      <div class="md:w-[70%] w-full">
        <div class="duration-500" class="quizContainer"></div>
      </div>
    ...
    <div
      class="fixed top-0 left-0 bg-zinc-900 bg-opacity-90 w-full h-full justify-center items-center z-20 hidden"
